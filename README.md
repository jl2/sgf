...
```
(ql:quickload :sgf)
(sgf:read-game-file "game1.sgf")

((("FF" . "4") ("CA" . "UTF-8") ("GM" . "1") ("DT" . "2024-01-15") ("PC" . "OGS: https://online-go.com/game/60687472")
  ("GN" . "myagkiy.disk vs. jlarocco") ("PB" . "myagkiy.disk") ("PW" . "jlarocco") ("BR" . "30k") ("WR" . "35k")
  ("TM" . "600") ("OT" . "4x30 byo-yomi") ("RE" . "W+T") ("SZ" . "13") ("KM" . "5.5") ("RU" . "Japanese")
  (("B" . "ih")
   (("W" . "dd")
    (("B" . "fc")
     (("W" . "dj")
